...
<head>
    ...
    <title>ฟอร์มรับสมัครงาน - อดิเทพ จำเริญเจือ (อาร์ม)</title>
        ...
        <div class="col-lg-8">
            <div class="card form-card">
                ...
                <div class="company-header text-center">
                    <h2><i class="bi bi-buildings-fill me-2"></i>บริษัท อดิเทพ จำเริญเจือ จำกัด</h2>
...
<?php
        if(isset($_POST['Submit'])){
            ...
            VALUES (NULL,'{$position}', '{$title}' ,'{$fullname}','{$dob}'
